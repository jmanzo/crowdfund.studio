function AddSingleBackerSection() {
    return (
        <div className="p-5">
            ...
            the steps and press Save. This backer will be created into a Shopify customer and the same process as{' '}
            any imported backer will apply to them.
            </p>
        </div>
    )
}

export default AddSingleBackerSection;