            ...
            <h3 className="optin__title dark:text-white">Sales don't need to end with the campaign. Make 30% more with Crowdfund Studio.</h3>
              <form className="optin__form" action="https://getform.io/f/742118ab-f792-426d-8080-5da2b90a339f" method="POST">
                <div className="optin__form-group form-group">                    
                  <input 
                    type="text" 
                    className="form-input optin__input focus-visible:outline-none" 
                    id="optin-name" 
                    name="name"
                    onChange={handleChange}
                    value={values['optin-name']}
                    required
                  />
                  <label className="optin__label text-cfsBlue dark:text-white">Your name</label>
                ...
                <div className="optin__form-group form-group">
                  <input 
                    ...
                    name="email"
                    onChange={handleChange}
                    value={values['optin-email']}
                    required
                  />
                  <label className="optin__label text-cfsBlue dark:text-white">Email address</label>
                  <span className="input-underline"></span>
                </div>
                ...
                <div className="optin__form-group form-group">
                  <input 
                    type="text" 
                    className="form-input optin__input focus-visible:outline-none" 
                    id="optin-project-link" 
                    name="link"
                    onChange={handleChange}
                    value={values['optin-project-link']}
                    required
                  />
                  <label className="optin__label text-cfsBlue dark:text-white">Project link</label>
                  <span className="input-underline"></span>
                </div>
                                        
                <button 
                  type="submit" 
                  // className="optin__btn btn btn--md btn--color btn--button"
                  className="optin__btn text-white bg-cfsOrange text-[0.9375rem] py-0 px-[25px] h-[46px] rounded"
                >
                  Try Beta
                </button>                 
              </form>
